...
export type LibrarySession = {
  ...
  family: string;
  /** Clés i18n d'affichage (`workouts.*`) — name/why/family restent
   *  français pour la génération des plans (contenu persisté). */
  nameKey: string;
  whyKey: string;
  familyKey: string;
  ...
  const sessions: LibrarySession[] = [
    {
      ...
      family: "Endurance",
      nameKey: "sessions.footing.name",
      whyKey: "sessions.footing.why",
      familyKey: "families.endurance",
      target: "universel",
    ...
    },
    {
      ...
      family: "Endurance",
      nameKey: "sessions.longue-endurance.name",
      whyKey: "sessions.longue-endurance.why",
      familyKey: "families.endurance",
      target: "marathon",
    ...
    },
    {
      ...
      family: "Endurance",
      nameKey: "sessions.longue-progressive.name",
      whyKey: "sessions.longue-progressive.why",
      familyKey: "families.endurance",
      target: "semi",
    ...
    },
    {
      ...
      nameKey: "sessions.allure-marathon.name",
      whyKey: "sessions.allure-marathon.why",
      familyKey: "families.racePace",
      target: "marathon",
    ...
    },
    {
      ...
      name: "Seuil · 2 × 20 min",
      family: "Seuil",
      nameKey: "sessions.seuil-2x20.name",
      whyKey: "sessions.seuil-2x20.why",
      familyKey: "families.threshold",
      target: "universel",
    ...
    },
    {
      ...
      family: "Seuil",
      nameKey: "sessions.seuil-fractionne.name",
      whyKey: "sessions.seuil-fractionne.why",
      familyKey: "families.threshold",
      target: "5k-10k",
    ...
    },
    {
      ...
      family: "VO2max",
      nameKey: "sessions.vo2max-1000.name",
      whyKey: "sessions.vo2max-1000.why",
      familyKey: "families.vo2max",
      target: "5k-10k",
    ...
    },
    {
      ...
      name: "VO2max · 5 × 3 min",
      family: "VO2max",
      nameKey: "sessions.vo2max-3min.name",
      whyKey: "sessions.vo2max-3min.why",
      familyKey: "families.vo2max",
      target: "5k-10k",
    ...
    },
    {
      ...
      family: "Vitesse",
      nameKey: "sessions.vitesse-300.name",
      whyKey: "sessions.vitesse-300.why",
      familyKey: "families.speed",
      target: "5k-10k",
    ...
    },
    {
      ...
      family: "Fartlek",
      nameKey: "sessions.fartlek-suedois.name",
      whyKey: "sessions.fartlek-suedois.why",
      familyKey: "families.fartlek",
      target: "universel",
    ...
    },
    {
      ...
      name: "Côtes · 8 × 45 s",
      family: "Côtes",
      nameKey: "sessions.cotes.name",
      whyKey: "sessions.cotes.why",
      familyKey: "families.hills",
      target: "trail",
    ...
    },
    {
      ...
      family: "Mixte",
      nameKey: "sessions.mixte-competition.name",
      whyKey: "sessions.mixte-competition.why",
      familyKey: "families.mixed",
      target: "semi",
    ...
    },
    {
      ...
      family: "Étalonnage",
      nameKey: "sessions.test-vdot.name",
      whyKey: "sessions.test-vdot.why",
      familyKey: "families.calibration",
      target: "universel",
